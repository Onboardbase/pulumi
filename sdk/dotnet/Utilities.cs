...
namespace Pulumi.Onboardbase
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Onboardbase.version.txt");
    ...
    internal sealed class OnboardbaseResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public OnboardbaseResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
